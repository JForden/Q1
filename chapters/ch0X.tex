...
Every time you unlock your phone with your face, get a movie suggestion from Netflix, or even follow a recipe to bake cookies, you are relying on algorithms at work.
...
Whether you are following directions to bake a cake, tie your shoes, or solve a Rubik's cube, you are using an algorithm.

In fact, we have all been using algorithms our entire lives, often without realizing it. From the way we open a door to the process of deciding what to eat for breakfast, our daily routines are full of these stepwise procedures. 
In machine learning, algorithms are the backbone: they tell the computer exactly how to turn messy, real-world data into useful predictions or decisions.
In traditional programming, a developer writes explicit rules that the computer must follow. 
